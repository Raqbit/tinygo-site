...
https://github.com/adafruit/Adafruit_nRF52_Bootloader/releases/download/0.4.0/circuitplayground_nrf52840_bootloader-0.4.0.zip
...
```shell
 adafruit-nrfutil --verbose dfu serial --package circuitplayground_nrf52840_bootloader-0.4.0_s140_6.1.1.zip -p /dev/ttyACM0 -b 115200 --singlebank --touch 1200
```
